...
- [x] Exclude frontmatter, code, Dataview fences, math, comments, embeds, URLs and existing links
...
- [x] Compare content hashes before replacing existing chunks or vectors
...
- [x] Unit tests cover protected-content chunking and sentence overlap
- [x] Unit tests cover bounded embedding batches and malformed vectors
- [x] Unit tests cover unchanged mtime and content-hash reuse
